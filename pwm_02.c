...
const float PWM_DIVISER = 125.0; // Divisor de clock ajustado conforme a atividade
const uint16_t WRAP = 20000;     // WRAP ajustado conforme a atividade
...
int main() {
    ...
    move_servo(2400, 5000); // Servo a 180 graus, aguarda 5 segundos
    move_servo(1470, 5000); // Servo a 90 graus, aguarda 5 segundos
    move_servo(500, 5000);  // Servo a 0 graus, aguarda 5 segundos
